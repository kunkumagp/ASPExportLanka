...
<div id="app" class="app">
    <div id="header" class="app-header navbar navbar-expand-lg p-0">
        <div class="container-xxl px-3 px-lg-5">
            ...
            >
                <img
                    src="{{ Vite::asset('resources/theme/assets/img/logo.png') }}"
                    class="invert-dark"
                    alt
                    height="22"
                />
    ...
    <div
        ...
        data-bs-theme="dark"
        style="
        background-image: url({{ Vite::asset('resources/theme/assets/img/landing/hero-cover.png') }});
        ...
        <div class="container-xxl p-3 p-lg-5">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="fs-18px text-body text-opacity-75 mb-4">
                            ...
                            Template <br />
                            to kickstart their startups, enhance company
                            projects, hone creative skills, <br />
                            or tackle freelance tasks.
                        </div>

                        <div
                            class="text-body text-opacity-35 text-center2 mb-4"
                        >
                        ...
                        <div class="row text-body mt-4 mb-4">
                            <div class="col-6 mb-3 mb-lg-0">
                                <div class="d-flex align-items-center">
                                    <div
                                        class="h1 text-body text-opacity-25 me-3"
                                    >
                                        <iconify-icon
                                            icon="bi:download"
                                        ></iconify-icon>
            ...
            >
                <img
                    ...
                    alt="Studio"
                    src="{{ Vite::asset('resources/theme/assets/img/landing/hero.jpg') }}"
                />
            </div>
        </div>
    </div>
    ...
    <div id="about" class="py-5 bg-component">
        <div class="container-xxl p-3 p-lg-5 text-center">
            ...
            <p class="fs-16px text-body text-opacity-50 mb-5">
                ...
                <br />developers, designers, and entrepreneurs, enabling
                effortless unleashing of creativity.
            </p>
            <div class="row text-start g-3 gx-lg-5 gy-lg-4">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        ...
                        <p class="mb-0">
                            Fast loading times and efficient coding practices
                            ensure a smooth user experience, even under heavy
                            traffic.
                        </p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        ...
                        <p class="mb-0">
                            ...
                            and ensuring your complete peace of mind.
                        </p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        ...
                        <p class="mb-0">
                            Join our vibrant community of developers and
                            designers, sharing insights and support.
                        </p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        <h4>24/7 Support</h4>
                        <p class="mb-0">
                            Our dedicated support team is always here to assist
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        ...
                        <p class="mb-0">
                            ...
                            business needs, ensuring reliability and
                            performance.
                        </p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
                    ...
                    <div class="flex-1 ps-3">
                        ...
                        <p class="mb-0">
                            Streamlined, intuitive interface designed for
    ...
    <div id="features" class="py-5 position-relative" data-bs-theme="dark">
        <div class="container-xxl p-3 p-lg-5 z-2 position-relative">
            <div class="text-center mb-5">
                ...
                <p class="fs-16px text-body text-opacity-50 mb-5">
                    ...
                    admin interfaces, enhancing productivity and user
                    satisfaction.
                </p>
            </div>
            <div class="row g-3 g-lg-5">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-1.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-1-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-2.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-2-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-3.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-3-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-4.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-4-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-5.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-5-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-6.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-6-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-7.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-7-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-8.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-8-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-9.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-9-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-10.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-10-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-11.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-11-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <a
                        href="{{ Vite::asset('resources/theme/assets/img/landing/mockup-12.jpg') }}"
                        data-lity
                        class="shadow d-block"
                        ><img
                            src="{{ Vite::asset('resources/theme/assets/img/landing/mockup-12-thumb.jpg') }}"
                            alt
                            class="mw-100"
                    /></a>
                    <div class="text-center my-3 text-body fw-bold">
        ...
        <div
            ...
            style="background-image: url({{ Vite::asset('resources/theme/assets/img/landing/content-cover.jpg') }})"
        ></div>
        <div
    ...
    <div id="pricing" class="py-5 bg-component">
        <div class="container-xxl p-3 p-lg-5">
            ...
            <p class="fs-16px text-body text-opacity-50 text-center mb-0">
                Choose the perfect plan that suits your needs. <br />Our pricing
                is designed to be flexible and affordable, providing value for
                businesses of all sizes. <br />Explore our plans to find the
            ...
            <div class="row g-3 py-3 gx-lg-5 py-lg-5">
                <div class="col-xl-3 col-md-4 col-sm-6 py-xl-5">
                    <div class="card border-0 rounded-4 h-100 bg-light">
                        <div
                            class="card-body fs-13px p-25px d-flex flex-column"
                        >
                            <div class="d-flex align-items-center">
                                <div class="flex-1">
                                    ...
                                    <div class="h2 fw-bold mb-0">
                                        $5
                                        <small
                                            class="h6 text-body text-opacity-50"
                                            >/month*</small
                                        >
                                    </div>
                                </div>
                            ...
                            <div class="mb-5 text-body text-opacity-75 flex-1">
                                <div class="d-flex align-items-center mb-1">
                                    <i
                                        class="fa fa-check fa-lg text-gray-500"
                                    ></i>
                                    <div class="flex-1 ps-3">
                    ...
                    <div class="card border-0 rounded-4 h-100 bg-light">
                        ...
                        >
                            ...
                            <div class="mb-5 text-body text-opacity-75 flex-1">
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    <i
                                        class="fa fa-check text-gray-500 fa-lg"
                                    ></i>
                                    <div class="flex-1 ps-3">
                                        <span class="font-monospace small"
                                            >Backup:</span
            ...
            <div class="row g-3 g-lg-4 mb-4">
                <div class="col-xl-4 col-md-6">
                    <div class="card p-4 border-0 h-100 rounded-5">
                        <div class="d-flex align-items-center mb-3">
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/user/user.jpg') }}"
                        ...
                        <div class="mb-4 d-flex">
                            ...
                            <div class="p-3">
                                ...
                                The customization options are unparalleled, and
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card p-4 border-0 h-100 rounded-5">
                        <div class="d-flex align-items-center mb-3">
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/user/user-7.jpg') }}"
                                class="rounded-circle me-3 w-50px"
                                alt="Client 1"
                            />
                            <div>
                        ...
                        <div class="mb-4 d-flex">
                            ...
                            <div class="p-3">
                                ...
                                template. The features are top-notch, and the
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card p-4 border-0 h-100 rounded-5">
                        <div class="d-flex align-items-center mb-3">
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/user/user-10.jpg') }}"
                                class="rounded-circle me-3 w-50px"
                                alt="Client 1"
                            />
                            <div>
                        ...
                        <div class="mb-4 d-flex">
                            ...
                            <div class="p-3">
                                ...
                                flexible, and the seamless integration has made
                                our projects run smoother than ever.
                            </div>
                            <div class="d-flex align-items-end">
                                <i
                                    class="fa fa-quote-right fa-2x text-body text-opacity-15"
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card p-4 border-0 h-100 rounded-5">
                        <div class="d-flex align-items-center mb-3">
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/user/user-8.jpg') }}"
                                class="rounded-circle me-3 w-50px"
                                alt="Client 1"
                            />
                            <div>
                        ...
                        <div class="mb-4 d-flex">
                            ...
                            <div class="p-3">
                                ...
                                expectations. The advanced features and
                                excellent support make it a standout choice.
                            </div>
                            <div class="d-flex align-items-end">
                                <i
                                    class="fa fa-quote-right fa-2x text-body text-opacity-15"
        ...
        <div class="container-xxl p-3 p-lg-5">
            <div class="text-center mb-5">
                ...
                <p class="fs-16px text-body text-opacity-50 text-center mb-0">
                    ...
                    <br />
                    on web development, design, and industry best practices.
            ...
            <div class="row g-3 g-xl-4 mb-5">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    >
                        <div>
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/landing/blog-1.jpg') }}"
                                alt
                        ...
                        <div class="flex-1 p-3 pb-0">
                            ...
                            <h5>
                                Mastering Responsive Design: A Guide for
                                Beginners
                            </h5>
                            <p>
                                Explore the fundamentals of responsive web
                                design and learn essential tips to create
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    >
                        <div>
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/landing/blog-2.jpg') }}"
                                alt
                                class="object-fit-cover h-200px w-100 d-block"
                            />
                        </div>
                        <div class="flex-1 p-3 pb-0">
                            ...
                            <p>
                                Discover the latest trends shaping user
                                interface and experience design in the digital
                                landscape this year.
                            </p>
                        </div>
                        <div class="p-3 pt-0 text-body text-opacity-50">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    >
                        <div>
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/landing/blog-3.jpg') }}"
                                alt
                                class="object-fit-cover h-200px w-100 d-block"
                            />
                        </div>
                        <div class="flex-1 p-3 pb-0">
                            ...
                            <p>
                                ...
                                boost your website’s visibility and drive
                                organic traffic.
                            </p>
                        </div>
                        <div class="p-3 pt-0 text-body text-opacity-50">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    >
                        <div>
                            <img
                                src="{{ Vite::asset('resources/theme/assets/img/landing/blog-4.jpg') }}"
                                alt
                                class="object-fit-cover h-200px w-100 d-block"
                            />
                        </div>
                        <div class="flex-1 p-3 pb-0">
                            ...
                            <h5>
                                Security Essentials: Protecting Your Website
                                from Cyber Threats
                            </h5>
                            <p>
                                Essential security measures and best practices
                                to safeguard your website and user data from
                                cyber threats.
                            </p>
                        </div>
                        <div class="p-3 pt-0 text-body text-opacity-50">
        ...
        <div class="container-xl p-3 p-lg-5">
            <div class="text-center mb-5">
                ...
                <p class="fs-16px text-body text-opacity-50 text-center mb-0">
                    ...
                    <br />
                    Whether you have inquiries, need support, or want to discuss
                    a partnership, <br />
            ...
            <div class="row gx-3 gx-lg-5">
                <div class="col-lg-6">
                    ...
                    <p>
                        ...
                        with you. Whether you’re looking for advice, have
                        questions, or want to share your ideas, feel free to
                        reach out.
                    </p>
                    <p>
                        <span class="fw-bolder">SeanTheme Studio, Inc</span
                        ><br />
                        ...
                        International:
                        <a href="#" class="text-theme">+11 (0) 123 456 78</a
                        ><br />
                        Email:
            ...
            <div class="row gx-lg-5 gx-3 gy-lg-4 gy-3">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-4">
                        ...
                        Designed for developers, designers, and entrepreneurs,
                        it provides the tools and flexibility needed to bring
...
<script data-cfasync="false" src="{{ Vite::asset('resources/theme/assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js') }}"></script>
<script src="{{ Vite::asset('resources/theme/assets/js/vendor.min.js') }}" type="ef76c6e0db526f2a9582f505-text/javascript"></script>
<script src="{{ Vite::asset('resources/theme/assets/js/app.min.js') }}" type="ef76c6e0db526f2a9582f505-text/javascript"></script>


<script src="{{ Vite::asset('resources/theme/assets/code.iconify.design/iconify-icon/2.1.0/iconify-icon.min.js') }}" type="ef76c6e0db526f2a9582f505-text/javascript"></script>
<script src="{{ Vite::asset('resources/theme/assets/plugins/lity/dist/lity.min.js') }}" type="ef76c6e0db526f2a9582f505-text/javascript"></script>
